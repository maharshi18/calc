...
# baseurl "https://download.docker.com/linux/#{platform}/#{node['platform_version'].to_i}/#{arch}/#{new_resource.repo_channel}"
    action :create do
        Chef::Log.warn("Entered create blockkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk")
...
#             end
            ...
            execute 'Docker gpg key' do
                command 'wget -qO - https://download.docker.com/linux/ubuntu/gpg | apt-key add -'
            end
#             execute 'Docker gpg key' do
#                 command 'apt update'
#             end
...
#             uri "https://download.docker.com/linux/ubuntu bionic stable"
#             arch deb_arch
